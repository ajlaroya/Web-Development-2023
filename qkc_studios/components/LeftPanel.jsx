...
const navList = ["Shop", "Search", "About", "Help", "Terms", "Privacy"];
...
const LeftPanel = () => {
  ...
  return (
    <div
      className={`${
        isOpen ? "flex" : "-translate-x-[420px]"
      } opacity-1 flex flex-col max-w-full min-w-[420px] h-auto bg-[#1d1d1d] w-[420px] p-[17px] md:bottom-[26px] bottom-[20px] left-[20px] md:left-[26px] overflow-y-auto md:top-[80px] top-[65px] z-[999] rounded-2xl transition duration-300`}
      aria-hidden="true"
    >
      <button
