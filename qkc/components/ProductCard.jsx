...
const ProductCard = ({ product }) => {
  ...
  return (
    <>
      {/* Product cards */}
      <div className="relative flex aspect-square w-auto cursor-pointer flex-col overflow-hidden rounded-xl bg-[#1d1d1d] text-[17px] leading-6 tracking-wide transition duration-300 first:cursor-none hover:-translate-y-1">
        {/* Card content */}
