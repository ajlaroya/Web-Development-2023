    ...
    >
      <div>
        ...
        <p>
          ...
          quietkidsclub.myshopify.com (the "<strong>Site</strong>") or otherwise
          communicate with us (collectively, the "<strong>Services</strong>").
          For purposes of this Privacy Policy, "<strong>you</strong>" and "
          <strong>your</strong>" means you as the user of the Services, whether
        ...
        <p>
          ...
          <em>"How we Collect and Use your Personal Information"</em> and{" "}
          <em>"How we Disclose Personal Information"</em>:
        </p>
        <table>
          <tbody>
            <tr>
