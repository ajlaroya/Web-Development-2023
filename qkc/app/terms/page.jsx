  ...
  return (
    ...
    >
      <div>
        ...
        contributors of content. <br /> <br /> Please read these Terms of
        ...
        limited to these Terms of Service. <br /> <br /> Any new features or
        tools which are added to the current store shall also be subject to the
        ...
        those changes. <br /> <br /> Our store is hosted on Shopify Inc. They
